...
if __name__ == '__main__':
    ...
    # Path Argument
    parser.add_argument('--vocab_path', type=str, default='./data/new_data/CN/Mammary/vocab.pkl',
                        help='the path for vocabulary object')
    parser.add_argument('--image_dir', type=str, default='./dataset/Ultrasonic_datasets/Mammary_dataset/Mammary_images',
                        help='the path for images')
    parser.add_argument('--caption_json', type=str, default='./data/new_data/CN/Mammary/captions.json',
                        help='path for captions')
    parser.add_argument('--train_file_list', type=str, default='./data/new_data/CN/Mammary/train_data.txt',
                        help='the train array')
    parser.add_argument('--val_file_list', type=str, default='./data/new_data/CN/Mammary/test_data.txt',
                        help='the val array')
    # transforms argument
