...
class VisualFeatureExtractor(nn.Module):
    ...
    def forward(self, image_frontal, image_lateral):
        ...
        # print(avg_frontal.size(), avg_lateral.size())
...
class SemanticEmbedding(nn.Module):
    def __init__(self, report_dim, embed_size):
        ...
        self.w1 = nn.Linear(in_features=report_dim, out_features=embed_size)
    ...
    def forward(self, avg):
        ...
        state_h = self.bn(self.w2(self.w1(report_tf)))
        return report_tf, state_h, state_h
