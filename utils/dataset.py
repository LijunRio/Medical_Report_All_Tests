...
if __name__ == '__main__':
    vocab_path = '../data/new_data/CN/Mammary/vocab.pkl'
    # vocab_path = '../data/new_data/vocab.pkl'
    image_dir = '../dataset/Ultrasonic_datasets/Mammary_dataset/Mammary_images'
    caption_json = '../data/new_data/CN/Mammary/captions.json'
    file_list = '../data/new_data/CN/Mammary/test_data.txt'
    batch_size = 2
    resize = 256
    crop_size = 224
