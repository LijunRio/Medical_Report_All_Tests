...
class ChestXrayDataSet(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return image, image_name, target, sentence_num, max_word_num
...
def collate_fn(data):
    ...
    images, image_id, captions, sentence_num, max_word_num = zip(*data)
...
if __name__ == '__main__':
    vocab_path = '../data/new_data/CN/Liver/vocab.pkl'
    image_dir = 'D:/postgraduate0/Datasets/Ultrasonic_datasets/Liver_dataset/Liver_images'
    caption_json = '../data/new_data/CN/Liver/captions.json'
    file_list = '../data/new_data/CN/Liver/test_text.txt'
    batch_size = 2
    resize = 256
    crop_size = 224
    ...
    for i, (image, image_id, target, prob) in enumerate(data_loader):
        print(image.shape)
        print(image_id)
        # print(label)
        print(target)
