...
class CaptionSampler(object):
    ...
    def test(self):
        ...
        stop_loss, word_loss, loss = 0, 0, 0, 0
        # self.extractor.eval()
        # self.mlc.eval()
        ...
        for i, (images, _, captions, prob) in enumerate(self.data_loader):
    ...
    def generate(self):
        ...
        for images, image_id, captions, _ in progress_bar:
        # for images, image_id, label, captions, _ in progress_bar:
            ...
            for i in range(self.args.s_max):
                ...
                ctx, alpha_v, = self.co_attention.forward(avg_features, prev_hidden_states)
                ...
                sampled_ids = self.word_model.sample(topic, start_tokens, self.args.cuda)
        ...
        with open(os.path.join(self.args.model_dir, self.args.result_path) + '/report.csv', 'w', encoding='utf-8-sig', newline='') as f:
            writer = csv.writer(f)
...
if __name__ == '__main__':
    ...
    """
    # Path Argument
    parser.add_argument('--model_dir', type=str, default='./report_v4_models/v4/20230619-07-24')
    ...
    parser.add_argument('--file_lits', type=str, default='./data/new_data/CN/Mammary/test_data.txt',
