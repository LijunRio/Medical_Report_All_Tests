...
if __name__ == '__main__':
    ...
    """
    # Path Argument
    parser.add_argument('--model_dir', type=str, default='./report_v4_models/v4/20220623-11-22')
    parser.add_argument('--image_dir', type=str, default='/home/mist/Ultrasonic_datasets/Liver_dataset/Liver_images',
                        help='the path for images')
    parser.add_argument('--caption_json', type=str, default='./data/new_data/CN/Liver/captions.json',
                        help='path for captions')
    parser.add_argument('--vocab_path', type=str, default='./data/new_data/CN/Liver/vocab.pkl',
                        help='the path for vocabulary object')
    parser.add_argument('--file_lits', type=str, default='./data/new_data/CN/Liver/test_text.txt',
