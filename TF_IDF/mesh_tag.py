...
f = open('D:/postgraduate0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/img2othersFull.pkl', 'rb')
mesh_data = pickle.load(f)
data = {}
for i in mesh_data:
    key = i.split("_")[0] # i是图片名称，分割后得到图片名称的第一部分，即形如CXR2384
    data[key] = mesh_data[i][-1]

with open('D:/postgraduate0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/annotation.json', 'r') as input:
...
for i in range(len(key_train)):
    key = key_train[i]['id'].split('_')[0] # 形如CXR2384
    value = data[key]
...
with open('D:/postgraduate 0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/mesh_data.json', 'w') as fp:
