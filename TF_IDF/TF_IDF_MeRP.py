...
output_pth = '../data/CN/Liver/TF_IDF_Report.json'

with open('../dataset/Ultrasonic_datasets/Liver_dataset/new_Liver2.json', 'r', encoding='utf-8-sig') as input:
    DATA = json.load(input)

with open('../data/CN/Liver/vocab_TF-IDF.json', 'r', encoding='utf-8-sig') as input:  # using the vocabulary of TF-IDF construction which can be different from the report generation vocabulary
