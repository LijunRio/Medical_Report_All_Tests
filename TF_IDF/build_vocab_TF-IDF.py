...
def main(json_file, threshold, vocab_path):
    ...
    js = 'D:/postgraduate0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/CN/Mammary/vocab_TF-IDF.json'
...
if __name__ == '__main__':
    main(json_file='D:/postgraduate0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/CN/Mammary/Mammary_annotation.json', threshold=3, vocab_path='D:/postgraduate0/Medical-Report-Generation-TriNet/Medical-Report-Generation-TriNet-main/data/CN/Mammary/vocab.pkl')
    # f = open('./vocab.json', 'r')
    # t = json.load(f)
    # t.sort()
